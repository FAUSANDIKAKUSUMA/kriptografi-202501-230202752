...
## 8. Kesimpulan
Praktikum ini berhasil mengimplementasikan fungsi-fungsi dasar aritmetika modular (penjumlahan, perkalian, dan eksponensiasi modular), serta algoritma untuk menghitung GCD (Greatest Common Divisor) dan invers modular menggunakan Extended Euclidean Algorithm. Implementasi ini menegaskan bahwa operasi modular adalah landasan matematis penting dalam kriptografi untuk menjaga hasil perhitungan tetap terbatas. Selain itu, simulasi sederhana logaritma diskrit menunjukkan kesulitan komputasi mencari eksponen , yang merupakan dasar keamanan bagi banyak skema kriptografi kunci publik.
